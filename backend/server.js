...
app.use((req, res, next) => {
    res.setHeader('Content-Security-Policy', "default-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.launchdarkly.com https://*.stripe.network https://*.replit.dev https://replit.com https://*.worf.replit.dev https://events.launchdarkly.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.launchdarkly.com https://*.stripe.network https://*.replit.dev https://replit.com https://m.stripe.network https://*.worf.replit.dev https://events.launchdarkly.com https://beacon.replit.com https://static.cloudflareinsights.com https://cdn.segment.com; style-src 'self' 'unsafe-inline' 'unsafe-hashes' https://*.replit.dev https://*.stripe.network data: blob:; img-src 'self' data: blob: https: https://*.cloudinary.com *; connect-src 'self' ws: wss: http: https: ws://localhost:* ws://0.0.0.0:* http://0.0.0.0:* https://0.0.0.0:* wss://*.replit.dev wss://*.worf.replit.dev https://*.launchdarkly.com https://*.stripe.network https://replit.com https://events.launchdarkly.com https://beacon.replit.com https://m.stripe.network https://api.segment.io https://*.cloudinary.com https://clientstream.launchdarkly.com; frame-src 'self' https://*.replit.dev https://*.worf.replit.dev https://replit.com https://*.stripe.network");
