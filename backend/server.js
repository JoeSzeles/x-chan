...
app.use((req, res, next) => {
    ...
    res.setHeader('Content-Security-Policy', 
        "default-src 'self' https://*.replit.dev https://*.worf.replit.dev https://*.youtube.com https://www.youtube.com; " +
        "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.replit.dev https://*.worf.replit.dev https://*.stripe.network https://*.youtube.com https://www.youtube.com; " +
        ...
        "https://events.launchdarkly.com https://*.cloudinary.com ws://* wss://* http://* https://* https://*.youtube.com https://www.youtube.com; " +
        "img-src 'self' data: blob: https: https://*.cloudinary.com https://*.ytimg.com https://*.youtube.com https://www.youtube.com; " +
        "frame-src 'self' https://*.youtube.com https://youtube.com https://www.youtube.com https://youtube-nocookie.com https://*.youtube-nocookie.com; " +
        "media-src 'self' https://*.youtube.com https://youtube.com https://www.youtube.com; " +
        "worker-src 'self' blob:; " +
        "style-src 'self' 'unsafe-inline' https://*.stripe.network https://*.youtube.com https://www.youtube.com;"
    );
    next();
});
