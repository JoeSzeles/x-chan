...
app.use((req, res, next) => {
    ...
    res.setHeader('Content-Security-Policy', 
        "default-src 'self' https://*.replit.dev https://*.worf.replit.dev https://www.youtube.com https://platform.twitter.com https://*.ytimg.com; " +
        ...
        "https://events.launchdarkly.com https://*.cloudinary.com ws://* wss://* http://* https://* https://*.ytimg.com; " +
        "img-src 'self' data: blob: https: https://*.cloudinary.com https://*.ytimg.com https://i.ytimg.com https://img.youtube.com; " +
