...
export default defineConfig({
	...
	server: {
		...
		headers: {
			...
			'Content-Security-Policy': "default-src 'self' https://*.replit.dev https://*.worf.replit.dev; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.launchdarkly.com https://*.stripe.network; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' data:; connect-src 'self' https://*.replit.dev wss://*.replit.dev https://*.launchdarkly.com https://*.stripe.network ws://localhost:* http://localhost:*",
		},
		proxy: {
			"/api": {
